...
* Lighting
  ...
  * A [Flux LED](https://www.home-assistant.io/components/light.flux_led/) compatible [RGBW controller](https://smile.amazon.co.uk/gp/product/B07BFPWZNJ/) to replace the Philips Hue [Philips Hue](https://www2.meethue.com/en-gb/p/hue-bridge/8718696516850) bridge (v2). The Hue bridge was a pain to get set up, it took literally dozens of attemps, and a few factory resets, to get it set up. Then it just stopped responding, even to the official app.
