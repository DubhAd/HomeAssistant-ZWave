...
Note |
---- |
I'm in the process of [migrating to a VM](https://blog.ceard.tech/2019/08/my-great-migration-part-one.html). That also uses a manual venv install (Python 3.7). The Z-Wave is staying on the Pi though. |
